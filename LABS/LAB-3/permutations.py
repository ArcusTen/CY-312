...
def permutation(data, type):
    mapping = None
    if type == "initial":
        mapping = initial_perm_map
    elif type == "compression":
        mapping = compression_perm_map
    elif type == "expansion":
        mapping = expansion_perm_map
    elif type == "pBox":
        mapping = pBox_perm_map
    elif type == "inverse":
        mapping = inverseInitial_perm_map
...
def sBox_permutation(data):
    ...
    for block_num, block in enumerate(blocks):
        mapping = sBox_perm_map[block_num]
